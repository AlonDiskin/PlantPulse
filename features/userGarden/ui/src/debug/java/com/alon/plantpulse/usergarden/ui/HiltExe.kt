package com.alon.plantpulse.usergarden.ui
...
inline fun <reified T : Fragment> launchFragmentInHiltContainer(
    activityClass: Class<out HiltTestActivity>? = null, //
    ...
    val startActivityIntent = Intent.makeMainActivity(
        ComponentName(
            ...
            activityClass ?: HiltTestActivity::class.java // HiltTestActivity::class.java
        )
    )
